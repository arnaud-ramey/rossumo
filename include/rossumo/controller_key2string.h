...
inline const char* controller_key2string(eARCONTROLLER_DICTIONARY_KEY & i) {
  switch (i) {
    ...
    case ARCONTROLLER_DICTIONARY_KEY_WIFI_ENVIRONEMENTCHANGED:
      return "WIFI_ENVIRONEMENTCHANGED";
